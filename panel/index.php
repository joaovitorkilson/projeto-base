...
if ($lines > 0) {
	$id_usuario = $queryResult[0]['id'];
	$nome_usuario = $queryResult[0]['name'];
	$email_usuario = $queryResult[0]['email'];
	$telefone_usuario = $queryResult[0]['cell_number'];
	$senha_usuario = $queryResult[0]['pass'];
	$nivel_usuario = $queryResult[0]['level'];
	$foto_usuario = $queryResult[0]['picture'];
	$endereco_usuario = $queryResult[0]['address'];
}
            ...
            <aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
                <nav class="navbar navbar-inverse">
                    <div class="navbar-header">
                        ...
                        <h1><a class="navbar-brand" href="index.php"><span class="fa fa-cutlery"></span> Sistema<span
                                    class="dashboard_text">Nome do Sistema</span></a></h1>
                    </div>
                        ...
                        <li class="dropdown profile_details_drop">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <div class="profile_img">
                                    <span class="prfil-img"><img src="images/perfil/<?= $foto_usuario ?>" alt="" width="50px"
                                            height="50px"> </span>
            ...
            <form id="form-perfil">
                <div class="modal-body">
					...
					<div class="row">
						...
						placeholder="Seu endereço" value="<?php echo $endereco_usuario ?>">
						</div>
					</div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" name="foto-logo" onChange="carregarImgLogo();"
                                    id="foto-logo">
                            </div>
                        </div>
                        <div class="col-md-2">
